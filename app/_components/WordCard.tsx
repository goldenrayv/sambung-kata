...
export default function WordCard({ word, search = "", searchMode = "prefix", isSuperUser = false, isVerified = "unverified", onDelete, onAccept }: Props) {
  ...
  return (
    <div
      className={`px-2.5 py-1.5 rounded-lg border flex items-center justify-between group transition-all duration-200 gap-2 overflow-hidden ${isVerified === "verified"
    ...
    >
      <span
        className={`whitespace-nowrap min-w-0 text-[11px] tracking-widest transition-colors uppercase ${isVerified === "verified"
